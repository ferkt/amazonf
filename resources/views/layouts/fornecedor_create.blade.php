            ...
            <div class="grid grid-cols-3 md:grid-cols-3">
                <div class="p-6">
                    <div class="flex items-center mb-4">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold" style="color:darkorange">Criar Fornecedor</div>
                    </div>
                    <div class="ml-1">
                                        ...
                                        <div class="form-group">
                                            <div class="col-auto g3">
                                                <label class="form-label">Nome</label>
                                                    <input type="text" class="form-control"  name="nome" placeholder="Nome Empresa">                                            
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <div class="col-auto g3">
                                                ...
                                                <input type="number" class="form-control" name="num" placeholder="001">                                            
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">                                    
                                    ...
                                    <div class="form-group">
                                        <div class="col-auto g3">
                                            <label class="form-label">CEP</label>
                                                <input type="text" class="form-control" name="cep" placeholder="000000-00">                                            
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <div class="col-auto g3">
                                            <label class="form-label">Contato</label>
                                                <input type="email" class="form-control" name="contato" placeholder="empresa@empresa.com.br">                                            
                                        </div>
                                    </div>
                                </div>
                                </div>                          
                                    ...
                                    <div class="form-group ">
                                        <div class="col-auto g3">
                                            <label class="form-label">CNPJ</label>
                                                <input type="text" class="form-control" name="cnpj" placeholder="000.000.0000.00.00-00">                                            
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <div class="col-auto g3">
                                            <label class="form-label">Inscrição</label>
                                                <input type="text" class="form-control" name="insc" placeholder="00000.0000.00">                                            
                                        </div>
                                    </div>
                                </div>
                                </div>
                                    ...
                                    <div class="form-group ">
                                        <div class="col-auto g3">
                                            <label class="form-label">Telefone</label>
                                                <input type="text" class="form-control" name="tel" placeholder="(00)0000-0000">                                            
                                        </div>
                                    </div>
                                </div>
                                </div>
